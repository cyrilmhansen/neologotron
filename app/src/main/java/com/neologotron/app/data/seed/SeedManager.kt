...
class SeedManager
    ...
    constructor(
        ...
        private fun readPrefixes() =
            readCsv("seed/neologotron_prefixes.csv").mapNotNull { row ->
                try {
                    PrefixEntity(
                        id = row[0],
                        form = row[1],
        ...
        private fun readRoots() =
            readCsv("seed/neologotron_racines.csv").mapNotNull { row ->
                try {
                    RootEntity(
                        id = row[0],
                        form = row[1],
        ...
        private fun readSuffixes() =
            readCsv("seed/neologotron_suffixes.csv").mapNotNull { row ->
                try {
                    SuffixEntity(
                        id = row[0],
                        form = row[1],
