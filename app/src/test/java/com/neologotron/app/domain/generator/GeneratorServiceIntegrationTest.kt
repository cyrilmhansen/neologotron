...
class GeneratorServiceIntegrationTest {
    ...
    @Test
    fun generate_respects_filters_and_templates() = runBlocking {
        val p = PrefixEntity(id = "p", form = "bio-", altForms = null, gloss = "vie", origin = null, connector = null, phonRules = null, tags = "", weight = 1.0)
        val r = RootEntity(id = "r", form = "aero-", altForms = null, gloss = "air", origin = null, domain = "", connectorPref = null, examples = null, weight = 1.0)
        val s = SuffixEntity(id = "s", form = "-logie", altForms = null, gloss = "étude", origin = null, posOut = "nom", defTemplate = "tech:étude de {ROOT}|poetic:qui évoque {ROOT}", tags = "", weight = 1.0)
        ...
        val resTech = service.generateRandom(tags = emptySet(), saveToHistory = false, mode = GeneratorRules.DefinitionMode.TECHNICAL, useFilters = true)
        ...
        val resPoetic = service.generateRandom(tags = emptySet(), saveToHistory = false, mode = GeneratorRules.DefinitionMode.POETIC, useFilters = true)
        assertTrue(resPoetic.word.startsWith("biaero"))
        assertEquals("qui évoque air", resPoetic.definition)
    }

    @Test
    fun filters_toggle_affects_duplicate_consonant_boundary() = runBlocking {
        val p = PrefixEntity(id = "p", form = "trans-", altForms = null, gloss = "à travers", origin = null, connector = null, phonRules = null, tags = "", weight = 1.0)
        val r = RootEntity(id = "r", form = "son-", altForms = null, gloss = "son", origin = null, domain = "", connectorPref = null, examples = null, weight = 1.0)
        val s = SuffixEntity(id = "s", form = "-ique", altForms = null, gloss = "adj.", origin = null, posOut = "adj", defTemplate = null, tags = "", weight = 1.0)
